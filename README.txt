...
The Main menu has three functions called 'Display', 'Trash' and 'Exit'.
...
and buttons that can affect each list in the same tab. Changing tabs 
...
Search option is available in the all display tables. A drop down menu 
...
Sorting a display table can be done by clicking on the column and works
both in an ascending and descending order.


-------------------------------------------------------------------------
* Add

Clicking this buttin will bring up an add menu depending on which 
display table was open previously.
	...
	1. Add Person
	   ...
	   have won a Turing award and their contribution to the computer 
	   science. If any information has been input incorrectly an error
	   label will show which part it is upon clicking the 'Add' button.
	...
	2. Add Computer
	   ...
	   input options: name, type and year built (if applicable).
	...
	3. Add Link
	   ...
	   the link will have been added successfully.
...
This menu contains deleted items from the displau lists and opts to
